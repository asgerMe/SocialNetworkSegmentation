...
parser.add_argument('--mcsamples', dest='mcsamples', required=False, default=900, type=int)
parser.add_argument('--fmcsamples', dest='fmcsamples', required=False, default=0, type=int)
